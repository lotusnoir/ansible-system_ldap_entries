...
## [2.2.1](https://github.com/lotusnoir/ansible-system_ldap_entries/compare/2.2.0...2.2.1) - 2025-11-29

### Commits

- add no changes on run flag to keep idempotence [`f4e5819`](https://github.com/lotusnoir/ansible-system_ldap_entries/commit/f4e5819b9f8551f8990511750556a38af6917f6d)
